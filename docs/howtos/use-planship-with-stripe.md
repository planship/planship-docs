...
Planship app for Stripe lets you define [***feature***](/concepts/feature-levers) and [***metered***](/concepts/metered-levers) levers, and configure [***entitlements***](/concepts/plans#entitlements) for your Stripe products, all directly from the Stripe UI.
...
Once you are singed in and the accounts are connected, Planship will automatically create a new [organization](/concepts/products#organizations) for your Stripe account, and mirror all of your products, customers and subscriptions (as Planship [plans](/concepts/plans), [customers](/concepts/customers) and subscriptions respectively).
...
First, you need to define [***feature***](/concepts/feature-levers) and [***usage***](/concepts/metered-levers) levers that represent dimensions that you price on. To manage levers, navigate to your Product catalog by clicking the **Products** link in the Planship app default view, or Stripe's **Product catalog** link.
...
With levers defined, you can now configure feature and usage [***entitlements***](/concepts/plans#entitlements) for individual products. Navigate to the product view in the Stripe dasboard (E.g. click its name in the Product Catalog), and the Planship app will display the **Entitlements** view for that product.
